...
class RedooCalendar_GeneratedCalendarUpdate_Action extends BaseActionController
{
    ...
    public function process(Vtiger_Request $request)
    {
        try {
            ...
            $generatedCalendar->setId($request->get('form')['id']);
            ...
            $generatedCalendar->setColor($request->get('form')['color']);

            $subscribe = new Subscribe();
            $subscribe->fetchByCalendarId($generatedCalendar->getId(), $connection->getId());
            $subscribe->setColor($request->get('form')['color']);
