...
class RedooCalendar_CalendarHide_Action extends BaseActionController
{
    ...
    public function process(Vtiger_Request $request)
    {
        try {
            ...
            $subscribe->fetchByCalendarId($request->get('calendar_id'), $this->getConnector()->getId());
            $subscribe->delete();
            ...
            echo json_encode([
                ...
                'message' => self::t('Calendar Unsubscribed Successfully')
            ]);
