...
class Autoload
{
    ...
    public static function autoloader($classname)
    {
        ...
        if (file_exists($path . $classNamePath . ".php")) {
            ...
            if (strpos($classNamePath, 'RedooCalendar/ConnectorPlugins') === 0) {
                $parts = explode('/', $classNamePath);

                require_once(vglobal('root_directory') . DS . 'modules' . DS . 'RedooCalendar' . DS . 'extends' . DS . 'connectors' . DS . $parts[2] . '.inc.php');
            }
        }
