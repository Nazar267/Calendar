...
/**
 ...
 It belongs to the ComplexCondition module and must not be distributed without complete extension
 * @version 1.0
 * @updated xxxx-xx-xx
**/
/**
...
class VtUtils
{
    ...
    public static function logSQLError($error, $sqlQuery = '') {
        if(!empty($error)) {
            \Workflow2::error_handler(E_ERROR, 'Database Error in Query '.$sqlQuery, "", "");
        }
    }	
